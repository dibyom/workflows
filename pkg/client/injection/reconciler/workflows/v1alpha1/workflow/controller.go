...
import (
	...
	versionedscheme "github.com/tektoncd/experimental/workflows/pkg/client/clientset/versioned/scheme"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	workflowInformer := workflow.Get(ctx)

	lister := workflowInformer.Lister()
